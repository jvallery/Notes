...
def test_ingest_cli_routes(monkeypatch, tmp_path):
    ...
    class FakePipeline:
        def __init__(self, vault_root, dry_run, verbose, generate_outputs, force, trace_dir=None):
            calls.append(("init", vault_root, dry_run, verbose, generate_outputs, force, trace_dir))
