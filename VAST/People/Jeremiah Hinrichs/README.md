...
```dataview
TASK
WHERE contains(text, "@JeremiahHinrichs") AND !completed
SORT due ASC
```
...
**Role**: VAST Data (Federal/technical)
**Relationship**: Internal collaborator (federal/technical)

**Background**:
- Technical contributor for federal/air-gapped readiness; has backchannel relationships on Google side; to provide compliance/ATO summaries and public artifacts.
