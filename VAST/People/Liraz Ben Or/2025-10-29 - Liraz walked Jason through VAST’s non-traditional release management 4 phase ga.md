...
created: { { DATE } }
status: "done"
counterpart: "[[Liraz Ben Or]]"
role: ""
team: ""
company: ""
series: "1-1/Liraz Ben Or"
cadence: "Weekly"
meeting_mode: "Video"
location_or_link: ""
calendar_url: ""
...
privacy: "internal"
ai_extracted: true
transcript_path: "00 Inbox/Transcripts/20251029 0831 Parallels Transcription.txt"
tags: [meeting, "1-1"]
---

# 1:1 — Liraz Ben Or — 2025-10-29
...
Liraz walked Jason through VAST’s non-traditional release management: 4 phase gates in a Waterfall model, overlapping planning/execution across majors, and a sustaining vForce for older versions. They discussed roles (product, architects, dev leadership), QA cycles and success targets, tools (wiki/Gantt/QTest), and how customer-driven priorities and anchor features with beta customers shape releases. Liraz shared 5.4 materials and will provide 5.5 status links; they plan a follow-up and an in-person sync during Jason’s late-November Tel Aviv visit.

## Key facts learned

- Four phase gates: PG1 scope review; PG2 plan/timeline and change management; PG3 code freeze and beta readiness; PG4 release.
- QA runs three cycles (Phase 1 all tests, Phase 2 failed tests only, Golden Run all tests) targeting 96–97% success.
- Release cadence is roughly every 5 months; planning for the next major overlaps with code freeze of the current.
- Recent/current: 5.4 released last week; 5.5 in execution toward feature freeze; 5.6 PG1 targeted in ~2 weeks.
- Sustaining vForce handles minors/hotfixes for older majors; aim to maintain major minus two; 5.1 gets hotfixes only.
- Unplanned 5.2 minors are shipping to fix upgrade issues; focus is to move customers to 5.3 now.
- Decision roles: product (e.g., Tomer) sources customer needs; architects (Asaf’s team) design; development leadership (Shachar) makes trade-off calls with product.
- Release managers work in parallel to split planning vs execution across majors (e.g., Orly and Roy).
- Tools: per-release wiki status pages, Excel Gantt, and QTest for QA; weekly internal status reviews with slides.
- Anchor features seek beta customers; change management can push features to later releases.
- Cloud components should be integrated into the same phase-gate and QA process, not released ad hoc.

## Outcomes

- Liraz shared 5.4 phase-gate materials with Jason.
- Agreement to share 5.5 status wiki and Gantt.
- Plan to schedule a deeper follow-up next week.
- Expectation to meet in person during Jason’s Tel Aviv trip (2025-11-23 to 2025-11-26).

## Decisions

- (none)

## Action items (for Liraz Ben Or)

- [x] Review 5.4 phase-gate decks and materials shared by Liraz @Jason Vallery ⏫ ✅ 2025-11-08
- [x] Send 5.5 status wiki and Gantt link(s) to Jason @Liraz Ben Or ⏫ ✅ 2025-11-08
- [x] Review 5.5 status wiki and Gantt @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Schedule a follow-up 1-1 next week to go deeper on the release process @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Coordinate with Asaf on thematic/architectural planning approach and how priorities are shaped beyond single-customer asks @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Plan and schedule an in-person sync in Tel Aviv during 2025-11-23 to 2025-11-26 @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Share current 5.5 anchor features and beta customers enlisted @Liraz Ben Or 🔽 ✅ 2025-11-08
- [x] Ensure cloud-driven features follow phase gates and are included in QA plans @Jason Vallery 🔼 ✅ 2025-11-08

## Follow-ups

- [x] Confirm the exact calendar date for 5.6 Phase Gate 1 @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Obtain access to the per-release wiki pages, QTest views, and the weekly status deck @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Connect with the current release managers for 5.5 and 5.6 (e.g., Orly and Roy) for working rhythms @Jason Vallery 🔽 ✅ 2025-11-08
- [x] Clarify official support policy for older majors (major minus two) and exceptions @Jason Vallery 🔽 ✅ 2025-11-08

## Risks

- 5.6 PG1 expected while 5.5 is not yet frozen may strain teams and context-switching.
- Release process details are largely tribal knowledge with limited written documentation.
- Strong customer-driven prioritization may lead to a complex product surface and fragmented scope.
- Older versions persist in the field, increasing sustaining load and hotfix pressure.
- 5.4 stability concerns slow migration, complicating the push toward newer majors.
- Developers may be distracted by planning the next release during current release code freeze.
- Cloud work released outside phase gates could become fluid and under-governed.

## Open questions

- Is there (or will there be) a formal, written document describing the phase-gate process and roles?
- What is the exact date planned for 5.6 Phase Gate 1?
- Who are the designated release managers for 5.5 and 5.6 (confirm names and responsibilities)?
- What is the official policy on supported majors and how strictly is major minus two enforced?
- Which anchor features define 5.5 and which beta customers are engaged for them?
- How will cloud product work be represented in phase gates and QA coverage across releases?
- What is the standard access path to the release wikis, Gantt, QTest dashboards, and weekly status materials?
