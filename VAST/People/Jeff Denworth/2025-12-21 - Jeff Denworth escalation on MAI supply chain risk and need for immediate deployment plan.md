...
**Date**: 2025-12-21
**With**: Jeff Denworth, Jason Vallery, Lior Genzel, Renen Hallak, Alon Horev, Shachar Fienblit, Avery Pham, Jonsi Stephenson, Rick Scurfield, Anson (Qi), Kushal (last name unknown), Mustafa (last name unknown), Majid Mohammed, Yunchao Gong, Karén Simonyan, Vamshi (last name unknown), Manish (likely Maneesh Sah), Sagar (last name unknown), Nidhi (last name unknown), Vipin (last name unknown)
...
- [?] Work with VAST Operations to confirm whether Microsoft MAI requirements are being tracked and to determine sourcing and ordering plan for the stated 2 EB near-term requirement and potential 100 EB total deal size. @Myself ⏫ #task #proposed #auto

- [?] Coordinate with Lior Genzel to ensure introductions are pursued to Majid Mohammed, Yunchao Gong, and Karén Simonyan (Microsoft MAI) to reduce reliance on Kushal as the sole conduit to Mustafa. @Myself ⏫ #task #proposed #auto

- [?] Decide the most strategic environment to run Anson (Qi)'s VAST PoC for 1,000 to 2,000 GPU scale testing (MAI and Vipin environment vs Nscale vs CoreWeave) and align with Alon Horev and Lior Genzel. @TBD ⏫ #task #proposed #auto

- [?] Prepare analysis of working capital and opportunity cost for VAST vs Microsoft if Microsoft is buying 100 EB, as requested by Jeff Denworth. @TBD #task #proposed #auto
...
- Jason Vallery reported hearing from multiple Azure contacts that the final decision for the MAI storage direction is made by Mustafa (last name unknown).

- Jason Vallery reported hearing from multiple Azure contacts that Kushal (last name unknown) cannot be trusted, and Jason is concerned Kushal may be misrepresenting VAST's preferred status to influence Mustafa.

- Jason Vallery stated he has no current relationship with Majid Mohammed, Yunchao Gong, or Karén Simonyan, and that Lior Genzel will lead getting introductions to them to build trust with MAI stakeholders.
...
- Renen Hallak stated that Microsoft should have its own flash allocation with NAND manufacturers and that VAST efficiencies could reduce Microsoft's NAND needs and potentially allow Microsoft to reallocate excess NAND to other customers.
