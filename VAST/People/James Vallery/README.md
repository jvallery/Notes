...
- James Vallery applied to roles at Nasdaq, Ibotta, DESRI, TRC Companies, Boost Mobile, and Prologis via LinkedIn job postings.

- James Vallery cannot figure out how to view 2nd-degree connections for a company on LinkedIn and asked Jason Vallery to check whether Jason knows anyone at the companies James applied to.

- James Vallery applied to a job posting at Nasdaq via LinkedIn (job ID 4343149040).

- James Vallery applied to a job posting at Ibotta via LinkedIn (job ID 4305297845).

- James Vallery applied to a job posting at DESRI via LinkedIn (job ID 4310026343).

- James Vallery applied to a job posting at TRC Companies via LinkedIn (job ID 4306127715).

- James Vallery applied to a job posting at Boost Mobile via LinkedIn (job ID 4329592935).
...
- Job search support for James Vallery

- Identifying connections at target companies (Nasdaq, Ibotta, DESRI, TRC Companies, Boost Mobile, Prologis)

- LinkedIn 2nd-degree connection visibility
