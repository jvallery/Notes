...
## Action Items
- [ ] Ping Josh Wentzell (Office of the CTO) to obtain VAST OVA access and onboarding for local lab testing @Myself 📅 2025-10-27 🔺 #task
- [ ] Coordinate with Andy Perlsteiner for SC lab access as a backup/quick-start environment @Myself 📅 2025-10-27 ⏫ #task
- [ ] Set up a local cluster with the VAST OVA to test Global Namespace, caching/prefetch, and GPU workflows @Myself 📅 2025-10-27 ⏫ #task
- [ ] Draft VAST Cloud SaaS operating model requirements (DevOps/LifeSite rotations, telemetry, 24x7 support) @Myself 📅 2025-10-27 ⏫ #task
