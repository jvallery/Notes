...
## Action Items
- [ ] Schedule a 1-hour Friday meeting to discuss pricing model and Salesforce demo @Tomer Hagay 📅 2025-11-08 ⏫ #task #proposed
- [ ] Prepare and deliver Salesforce walkthrough (dashboards, feature/request tracking) @Tomer Hagay 📅 2025-11-08 ⏫ #task #proposed
- [ ] Draft initial cloud design qualifiers checklist (multi-tenancy, call home/instrumentation, GUI analytics) for inclusion in FRDs @Myself 📅 2025-11-08 🔺 #task #proposed
- [ ] Compile current multi-tenancy gaps across features (e.g., data spaces per-tenant, auth, replication) to inform backlog @Tomer Hagay 📅 2025-11-08 🔺 #task #proposed
- [ ] Review 5.5 plan with Shahar to align and prioritize cloud-critical items @Shachar Feinblit 📅 2025-11-08 ⏫ #task #proposed
- [ ] Arrange face time with Sahar in Tel Aviv to align on PM model and cloud requirements @Myself 📅 2025-11-08 🔺 #task #proposed
- [ ] Set up a sit-down with Jeff (and potentially Noah/Eyal) to clarify ownership boundaries for cloud vs core @Myself 📅 2025-11-08 🔺 #task #proposed
- [ ] Consolidate multi-tenancy issues raised by Leora and Iki into a succinct findings doc @Myself 📅 2025-11-08 ⏫ #task #proposed
- [ ] Provide a list of customers using multi-tenancy and their models (self-managed vs admin-only) @Tomer Hagay 📅 2025-11-08 🔽 #task #proposed
- [ ] Confirm whether multi-tenancy will be mandated as a qualifier for all new features going forward @Tomer Hagay 📅 2025-11-08 ⏫ #task #proposed
