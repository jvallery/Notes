...
## Action Items
- [ ] Schedule a 1-hour Friday meeting to discuss pricing model and Salesforce demo @Tomer Hagay 📅 2025-11-08 ⏫ #task
- [ ] Prepare and deliver Salesforce walkthrough (dashboards, feature/request tracking) @Tomer Hagay 📅 2025-11-08 ⏫ #task
...
- [ ] Compile current multi-tenancy gaps across features (e.g., data spaces per-tenant, auth, replication) to inform backlog @Tomer Hagay 📅 2025-11-08 🔺 #task
- [ ] Review 5.5 plan with Shahar to align and prioritize cloud-critical items @Shachar Feinblit 📅 2025-11-08 ⏫ #task
...
- [ ] Provide a list of customers using multi-tenancy and their models (self-managed vs admin-only) @Tomer Hagay 📅 2025-11-08 🔽 #task
- [ ] Confirm whether multi-tenancy will be mandated as a qualifier for all new features going forward @Tomer Hagay 📅 2025-11-08 ⏫ #task
