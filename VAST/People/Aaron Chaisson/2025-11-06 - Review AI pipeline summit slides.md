...
## Action Items
- [ ] Refine training slides to show continuous loop, clarify pretraining vs tuning, and depict fine-tuning/reinforcement learning terminology @Aaron Chaisson 📅 2025-11-08 ⏫ #task
- [ ] Adjust RAG slides to show precomputed embeddings (NIMs on Kubernetes), retriever and re-ranker flow, and explicit chatbot-to-inference linkage @Aaron Chaisson 📅 2025-11-08 ⏫ #task
...
- [ ] Distribute Ray diagram links and incorporate any applicable patterns into the slides @Aaron Chaisson 📅 2025-11-08 🔽 #task
