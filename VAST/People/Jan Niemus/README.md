...
**Role**: Runs DoD/IC organization at Google (DoD/IC)
**Relationship**: Partner stakeholder (Google Federal/IC)

**Background**:
- Google DoD/IC leader; personal friend of a meeting participant; previously a VP in Cisco’s DoD/IC sector and brought Cisco relationships into Google; approved/pushing Fort Meade POC.
