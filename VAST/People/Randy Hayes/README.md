...
**Background**:
- Preparing an EBC-style briefing on AI workloads/storage patterns/air-gapped operations for Google; previously associated with Avere (per Jason’s comment).
