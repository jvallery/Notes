...
Jason Vallery and Josh Wentzell held an introductory 1:1 to align on VAST on Cloud strategy and identify current platform gaps blocking a true multi-tenant SaaS offering. Josh highlighted multi-tenancy API and GUI limitations, VOC deployment friction, and automation gaps (Terraform coverage and lack of an official Ansible collection), while noting strong CSI adoption and rising CoSy interest.
