...
## Action Items
- [ ] Connect with Gordon Brown to review CoreWeave/XAI SLAs, response targets, and penalty clauses. @Myself 📅 2025-11-08 🔺 #task
- [ ] Draft an initial operating model for VAST-as-a-Service (SRE vs CS roles, on-call, communications, SLAs). @Myself 📅 2025-11-08 ⏫ #task
- [ ] Deep-dive with Rick on XAI workload patterns (checkpointing, GPU-adjacent caching, data flows) to inform cloud design. @Myself 📅 2025-11-08 ⏫ #task
- [ ] Assess feasibility/roadmap options for XAI’s multi-cluster single-namespace/filesystem request. @Myself 📅 2025-11-08 ⏫ #task
- [ ] Obtain and review the legal SLA document and any penalty clauses for CoreWeave/XAI. @Myself 📅 2025-11-08 🔺 #task
- [ ] Validate the current after-hours and weekend coverage model across APJ/EMEA for critical incidents. @Myself 📅 2025-11-08 ⏫ #task
- [ ] Confirm details of XAI’s cloud data location/provider and how data is repatriated to VAST clusters. @Myself 📅 2025-11-08 🔽 #task
- [ ] Review Slack alarm channel configurations and escalation paths to support proactive outreach. @Myself 📅 2025-11-08 🔽 #task
