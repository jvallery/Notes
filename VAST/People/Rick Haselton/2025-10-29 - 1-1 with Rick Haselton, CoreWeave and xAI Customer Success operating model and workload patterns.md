---
type: "people"
title: "1:1 with Rick Haselton, CoreWeave and xAI Customer Success operating model and workload patterns"
date: "2025-10-29"
person: ""
...
# 1:1 with Rick Haselton, CoreWeave and xAI Customer Success operating model and workload patterns
...
Jason Vallery met 1:1 with Rick Haselton to understand how VAST Customer Success supports CoreWeave and xAI and what that implies for a future VAST-as-a-Service operating model. Rick described a managed-services/SRE-style engagement (Slack-first, ticketing in Salesforce and JIRA, proactive monitoring), common incident drivers (networking and node failures), and constraints in current product capabilities (no single file system across multiple clusters).
...
*Source: [[2025-10-29 - Intro 1-1 to understand Customer Success operations for CoreWeave and XAI and im]]*