...
## Action Items
- [ ] Run 100–200 node scale tests for distributed cache and record performance/resilience results @Akanksha 📅 2025-10-26 🔺 #task #proposed
- [ ] Capture network throughput reduction to Blob with and without cache during scale tests @Akanksha 📅 2025-10-26 🔺 #task #proposed
- [ ] Measure TPS per node to metadata/blob and extrapolate scalability to 10k–100k nodes @Tomer Hagay 📅 2025-10-26 🔺 #task #proposed
- [ ] Finalize AKS Linux mount integration steps and prepare demo @Amit 📅 2025-10-26 ⏫ #task #proposed
- [ ] Hand off AKS setup and build to Vishnu for validation @Amit 📅 2025-10-26 ⏫ #task #proposed
- [ ] Prepare private preview plan (customers, docs, enablement) and align stakeholders @Vishnu 📅 2025-10-26 🔺 #task #proposed
- [ ] Document supported scenarios and explicit limitations for MVP @Vishnu 📅 2025-10-26 🔺 #task #proposed
- [ ] Investigate feasibility of SSD-only KV cache offload without cloud tier for CoreAI @Amit 📅 2025-10-26 ⏫ #task #proposed
- [ ] Continue resilience and performance tuning for distributed cache @Sourav 📅 2025-10-26 ⏫ #task #proposed
- [ ] Review AWS PyTorch S3 storage writer and evaluate applicable prefix/naming learnings @Amit 📅 2025-10-26 🔽 #task #proposed
- [ ] Evaluate long-term approach: contribute caching into Python/open-source tools vs kernel-mode driver @BlobFuse Engineering Team 📅 2025-10-26 🔽 #task #proposed
- [ ] Reassess AKS CSI driver path with containers team and document concerns/timeline @AKS Containers Team 📅 2025-10-26 ⏫ #task #proposed
- [ ] Assemble data-driven narrative for MAI (scale targets, throughput reduction, reliability) @Amit 📅 2025-10-26 ⏫ #task #proposed
- [ ] Schedule and run deep-dive to address Vishnu’s requirements list (use BlobFuse meeting if possible) @Vishnu 📅 2025-10-26 ⏫ #task #proposed
- [ ] Confirm Figure AI preview timing and environment details (VMSS vs AKS) and next steps @Vishnu 📅 2025-10-26 🔺 #task #proposed
- [ ] Share AKS Linux mount setup instructions with stakeholders for trial @Amit 📅 2025-10-26 ⏫ #task #proposed
- [ ] Align on measurement methodology and tooling for throughput and TPS metrics @Akanksha 📅 2025-10-26 🔺 #task #proposed
- [ ] Re-engage MAI after metrics and scalability narrative are ready @Myself 📅 2025-10-26 ⏫ #task #proposed
