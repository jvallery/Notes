...
## Action Items
- [ ] Probe with Pete about the status of the high-TPS Databricks/Chat-related workload and capacity implications. @Myself 📅 2025-10-26 🔺 #task
- [ ] Review and incorporate/resolve Jason’s comments on the Apollo documents. @Jai Menon 📅 2025-10-26 ⏫ #task
- [ ] Define Apollo workload targets: GPU cluster size per site (e.g., 4K vs 8K), storage throughput per GPU, and degree of geo disaggregation. @TBD 📅 2025-10-26 🔺 #task
- [ ] Deepen research on Vast/CoreWeave’s persistent KV and data pipeline approach and assess applicability to Apollo’s shared namespace/consistency needs. @Myself 📅 2025-10-26 ⏫ #task
- [ ] Provide Jason with specific next research topics and sources to investigate. @Jai Menon 📅 2025-10-26 ⏫ #task
- [ ] Confirm whether the new ‘Matt UK’ supercomputer deal aligns with Apollo or Fairwater. @Jai Menon 📅 2025-10-26 🔽 #task
- [ ] Clarify details on the DFW enrichment sites (approx. 160,000 GB200s under one roof) and implications for Apollo design. @Jai Menon 📅 2025-10-26 🔽 #task
