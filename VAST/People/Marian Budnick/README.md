...
TASK
FROM ""
WHERE !completed AND contains(text, "Marian Budnick")
SORT due ASC
```
...
```dataview
TASK
WHERE contains(text, "@MarianBudnick") AND !completed
SORT due ASC
```
...
**Role**: CMO at VAST Data (Marketing)
**Location**: Boston
**Relationship**: Internal executive (mentioned)

**Background**:
- Part of Boston hub leadership.
