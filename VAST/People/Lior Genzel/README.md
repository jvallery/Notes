...
- [ ] Clarify what the Microsoft hardware SKU implies/means for the workstream.
- [ ] Follow up on the POC with MAI (scope/status/next steps).
- [ ] Define/expand VoC approach more broadly (what is needed, how it will be used).
- [ ] Determine relevance/next steps regarding Google in this context.
