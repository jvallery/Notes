...
```dataview
TASK
WHERE contains(text, "@JohnCedillo") AND !completed
SORT due ASC
```
...
**Background**:
- Driving partner referral incentive program through legal; managing follow-ups on Accenture update, Cisco alignment, and referral program communications.
