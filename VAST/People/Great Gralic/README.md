...
TASK
FROM ""
WHERE !completed AND contains(text, "Great Gralic")
SORT due ASC
```
...
```dataview
TASK
WHERE contains(text, "@GreatGralic") AND !completed
SORT due ASC
```
...
**Background**:
- Attended early June meeting related to Cisco gear POC planning with Google/DoD-IC context.
