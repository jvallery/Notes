...
- [?] Provide Google (David Pawlak) clarification on how VAST's proposed GDC Storage RFP offering meets FIPS compliance standards, addressing the question raised by Kamal Vyas. @TBD 📅 2025-12-19 ⏫ #task #proposed #auto

- [?] Confirm to Google (David Pawlak) that recurring pricing in the GDC Storage RFP proposal includes hardware and SSDs, and clarify that VAST does not sell HDDs, plus note pricing validity window if appropriate. @Lior Genzel 📅 2025-12-19 #task #proposed #auto

- [?] Check with VAST partner organization for the full list of global certified hardware partners for BYOH and share the list with Google (David Pawlak). @Lior Genzel 📅 2025-12-23 #task #proposed #auto
...
- Lior Genzel (VAST Data) stated that VAST's proposed GDC Storage RFP solution includes hardware pricing and includes SSDs, and that VAST does not sell HDDs.
...
- Lior Genzel (VAST Data) stated that Jason Vallery will take the lead on answering whether the proposed solution uses Self-Encrypting Drives (SEDs) for the SSD component.

- Lior Genzel (VAST Data) stated VAST can work with Google to certify a Google-preferred hardware partner for BYOH given the business upside of the GDC Storage RFP opportunity.

- Lior Genzel (VAST Data) stated VAST already has Cisco, Dell, HPE, and SuperMicro certified as eBox partners for VAST deployments.

- Lior Genzel (VAST Data) stated Arrow and Avnet are certified as ODM partners manufacturing VAST C-Box and D-Box solutions.

- David Pawlak (Google) requested clarification on how VAST's proposed offering meets FIPS compliance standards, referencing a question raised by Kamal Vyas.
