...
source: "transcript"
source_ref: "Inbox/_archive/2025-10-24/2025-10-24 - Jason and Tomer discussed accelerating VAST’s engineering maturity and cloud str.md"
tags:
  - "type/customer"
  - "account/vast"
  - "generated"
...
## Action Items
- [ ] Align with Shachar on AI development program goals and adoption metrics @Myself 📅 2025-10-26 🔺 #task
- [ ] Draft proposal for AI-enabled dev workflow (PR/audits, agent usage) and training cadence @Myself 📅 2025-10-26 🔺 #task
- [ ] Validate cloud P0 prioritization and resourcing with Brendan and Jeff @Myself 📅 2025-10-27 ⏫ #task
- [ ] Review and document current end-to-end dev lifecycle, gates, and tooling (RFE→Feature→Jira→Release) @Myself 📅 2025-10-26 ⏫ #task
- [ ] Contact Andy Perlsteiner to obtain SE lab access for hands-on evaluation @Myself 📅 2025-10-26 ⏫ #task
- [ ] Coordinate with Josh (Office of the CTO) to obtain OVA/bits for local testing @Myself 📅 2025-10-26 ⏫ #task
