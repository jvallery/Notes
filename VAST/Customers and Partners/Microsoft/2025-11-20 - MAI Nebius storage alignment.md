...
- [ ] Share VAST sizing examples, performance/capacity design options, and management/API documentation with Microsoft (including Suresh). @Myself ⏫ #task
...
- [ ] Validate VAST supply chain and lead times for the 2026 ramp (flash, compute/data node quantities) and propose tranche sizing aligned to MAI dates. @Myself #task
...
- [ ] Align on deduplication planning assumptions to set effective capacity targets for MAI datasets. @Lior Genzel Genzel 🔽 #task
- [ ] Send meeting notes and VAST design tables to MAI stakeholders. @Myself #task
