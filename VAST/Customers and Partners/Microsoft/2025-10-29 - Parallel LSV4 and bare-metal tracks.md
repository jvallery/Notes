...
## Action Items
- [ ] Review and approve the shared VAST configuration; drive internal approval and expedite shipping/installation and QA readiness. @Leo 📅 2025-11-08 🔺 #task
- [ ] Connect Nico with Roni to align VM type, region, and availability for December readiness. @Leo 📅 2025-11-08 ⏫ #task
- [ ] Coordinate VM choice (LS96 vs LS192) and target region for the December test cluster. @Nico 📅 2025-11-08 🔺 #task
- [ ] Deliver an 8-node LSV4-based VAST test system in the UK Met tenant (early December target). @Leo 📅 2025-11-08 ⏫ #task
- [ ] Prepare Azure demo for Supercomputing/Ignite (week of 2025-11-17). @Leo 📅 2025-11-17 🔺 #task
- [ ] Ping Sara to confirm mid-November commitment on the EGAL/compute platform timeline and capacity. @Tiff 📅 2025-11-08 🔺 #task
- [ ] Follow up with PM on RDMA timelines and scope (VM-to-VM, GPU-to-VAST, east-west vs north-south, VNet/MTU limits). @Nico 📅 2025-11-08 🔺 #task
- [ ] Set up a separate engineering track/workshop for Polaris/Lifter and data-plane integration (VAST, Azure, UK Met). @James 📅 2025-11-08 ⏫ #task
- [ ] Build and share a BOM for the bare-metal dev system. @James 📅 2025-11-08 🔺 #task
- [ ] Discuss with Anand DC location, ownership, and purchase of the bare-metal dev system; aim for an answer by Supercomputing. @Mike 📅 2025-11-08 🔺 #task
- [ ] Open the T&Cs/commercials/KPIs discussion and involve John. @Claire 📅 2025-11-08 ⏫ #task
- [ ] Provide OEM preferences (ranked) for secure supply (e.g., HPE and alternatives). @TBD 📅 2025-11-08 ⏫ #task
- [ ] Engage Ed Kim to align procurement path and approved OEM list. @James 📅 2025-11-08 ⏫ #task
- [ ] Draft GPFS swap design for Gen1 Slingshot path (risks, performance, approval needs) with Trevor. @Trevor 📅 2025-11-08 🔽 #task
- [ ] Share compute status on NVMe persistence/dedicated hosts feasibility for L-series/LSV5. @Leo 📅 2025-11-08 ⏫ #task
- [ ] Define a non-Marketplace software procurement route for internal Microsoft subscriptions. @James 📅 2025-11-08 🔺 #task
- [ ] Confirm LSV5 AMP and proposed 800G/300TB SKU timeline and suitability for UK Met (mid-November answer). @Tiff 📅 2025-11-08 🔺 #task
- [ ] Verify RDMA announcement at Ignite and applicability to LSV4/LSV5; validate private review timing. @Nico 📅 2025-11-08 🔺 #task
