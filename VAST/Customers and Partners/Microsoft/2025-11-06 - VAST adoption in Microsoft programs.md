...
## Action Items
- [ ] Reach out to Kushal to gauge willingness to push VAST bare metal on classic Azure for Dallas and align next steps. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Quietly brief Nidhi on the VAST-optimized Azure storage hardware path and secure her support. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] If Nidhi aligns, coordinate an intro with Michael Myrah to discuss a co-designed VAST-optimized Azure storage SKU. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Ask Azure Storage team if NVIDIA has requested DGX storage benchmarking/compliance and relay findings. @Kanchan 📅 2025-11-08 #task
- [ ] Circle with Lior on framing the Nidhi/Renan session, emphasizing DGX storage requirements and bare-metal path. @Jason 📅 2025-11-08 #task
- [ ] Confirm Nidhi’s availability and schedule a focused deep-dive with Renan/Lior and VAST leadership. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Update on Kushal conversation and whether MAI will sponsor the Dallas classic-Azure VAST exploration. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Track status of Apollo POC hardware arrival and start of VAST testing in the target Azure data center. @Jason 📅 2025-11-08 #task
