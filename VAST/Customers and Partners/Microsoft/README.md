...
- Potential to leverage OpenAI-written IP/source code for Azure services
- Decision on Blob API vs Tuscany direction impacting Microsoft ecosystem
- Microsoft competitive positioning (Azure Storage gaps)
- Azure-focused cloud play positioning

## Blockers

- ❌ Risk/uncertainty around OpenAI-Microsoft relationship changes and AGI clause timing
- ❌ Azure Storage limitations referenced in context of China

## Collaborators

| Person | Role | Company |
|--------|------|---------|
| [[Pete Eming]] |  | Microsoft |
| [[Jeff Denworth]] |  | VAST |
| [[Jason Vallery]] |  |  |
| [[Manish]] |  | Microsoft |
| [[Jason]] |  | VAST |
