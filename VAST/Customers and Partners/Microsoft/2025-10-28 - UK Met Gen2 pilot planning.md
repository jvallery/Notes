...
- [ ] If full VM SKU is delayed, confirm starting tests on the 100 Gb VM and plan migration path. @Niko 📅 2025-10-29 ⏫ #task
- [ ] Confirm pilot validation criteria map to contract mandatory requirements. @Myself ⏫ #task
