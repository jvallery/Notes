...
## Action Items
- [ ] Reach out to Kushal Bhatta to assess MAI’s appetite for VAST as storage for Dallas (especially April) and clarify current plan-of-record hardware. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Seed the VAST-on-Azure-storage bare-metal strategy with Nidhi and secure a meeting including Renan. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Coordinate with Lior and Renan to request/prepare for an exec meeting with Nidhi (pre/post Ignite). @Jason 📅 2025-11-08 ⏫ #task
- [ ] Ask Azure Storage team whether they have received NVIDIA DGX storage performance requirements and whether any storage benchmarking has been requested. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Draft a plan for running VAST bare metal on classic Azure, including Overlake/SDN interoperability and networking approach, pending MAI greenlight. @Jason 📅 2025-11-08 ⏫ #task
- [ ] Finalize and circulate the exabyte cost/power/performance comparison slide for exec discussions. @Jason 📅 2025-11-08 ⏫ #task
- [ ] Open a conversation with Michael Myrah about co-engineering a VAST-optimized Azure Storage hardware SKU after securing Nidhi’s support. @Kanchan 📅 2025-11-08 ⏫ #task
- [ ] Explore Azure Dedicated (Anand) as a parallel bare-metal path if needed. @Kanchan 📅 2025-11-08 🔽 #task
- [ ] Track Apollo POC progress (rack arrival, VAST on Azure storage hardware, and DPU choice between Fungible and BlueField 3). @Jason 📅 2025-11-08 ⏫ #task
- [ ] Schedule and confirm the meeting with Nidhi and Renan; align on engagement model and licensing approach. @Kanchan 📅 2025-11-08 ⏫ #task
