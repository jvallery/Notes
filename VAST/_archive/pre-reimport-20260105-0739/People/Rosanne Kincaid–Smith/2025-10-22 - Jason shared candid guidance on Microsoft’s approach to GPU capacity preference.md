...
privacy: "internal"
ai_extracted: true
transcript_path: "00 Inbox/Transcripts/20251022 1103 Teams Meeting (Parallels) Transcription.txt"
tags: [meeting, "1-1"]
---

# 1:1 — Rosanne — 2025-10-22
...
Jason shared candid guidance on Microsoft’s approach to GPU capacity: preference for in-house builds with selective neo‑cloud partnerships to offload GPU capex risk. They discussed lease dynamics, 5‑year depreciation uncertainty, workload placement tradeoffs (training vs inference), and the importance of fiber proximity to hyperscaler hero regions. Rosanne outlined Dhammak’s rapid data center and GPU cloud buildout and pursuit of Microsoft as an anchor tenant. Both aligned on market dynamics; no concrete decisions or dates set.

## Key facts learned

- Jason is day 3 at VAST, leading product management focused on hybrid scalers and frontier model builders
- Rosanne is based in Dubai; recently joined Dhammak Group to build a vertically integrated GPU/cloud platform
- Dhammak diversified into data centers ~4 years ago and acquired nearly 5 GW of power and land
- Targeting ~500 MW capacity online by early next year with multi‑gigawatt expansion across Asia, US, and Europe
- Strategy includes securing a marquee tenant similar to Microsoft’s partnerships with CoreWeave and others
- Lior is facilitating a conversation with Anand at Microsoft
- Microsoft prefers in‑house builds but uses neo‑clouds to hedge capacity gaps and shift GPU capex risk
- Lease pullbacks were finance‑driven balance sheet risk management; some leases later resumed as demand materialized
- GPU asset life/depreciation (often modeled at 5 years) is uncertain given rapid accelerator roadmaps
- Workload mix depends on network: remote power‑rich sites without major fiber are better for inference than training
- Data gravity is flipping as compute chases power; storage must move data to compute
- VAST’s global data namespace is positioned to connect data to distributed compute

## Outcomes

- Aligned on Microsoft’s current leasing and neo‑cloud partnership posture and rationale
- Validated Rosanne’s understanding of market dynamics and timing sensitivities
- Identified network/fiber proximity as a key determinant for workload placement and tenant fit

## Decisions

- (none)

## Action items (for Rosanne)

- [x] (none) ✅ 2025-10-26

## Follow-ups

- [x] Proceed with Microsoft engagement (conversation with Anand facilitated by Lior) regarding marquee tenant options. @Rosanne 🔼 ✅ 2025-10-26
- [x] Evaluate data center site selection against fiber routes to hyperscaler hero regions to support training workloads where feasible. @Rosanne 🔼 ✅ 2025-10-26
- [x] Refine financial model to absorb GPU asset risk and ensure cluster fungibility/repurposing across training and inference tenants. @Rosanne 🔼 ✅ 2025-10-26

## Risks

- GPU depreciation and demand uncertainty may impair 5‑year ROI models
- Limited fiber connectivity at power‑rich sites constrains training workloads
- Municipal permitting pushback can delay traditional metro expansions
- Overreliance on Microsoft leases exposes counterparties to balance‑sheet reversals
- Inflexible clusters without fungibility/repurposing options risk underutilization

## Open questions

- What is the timing of Microsoft’s capacity needs relative to Dhammak’s earliest available clusters?
- Should Dhammak pursue plain colocation leases with Microsoft in parallel to neo‑cloud models?
- Which initial workloads (training vs inference) best match early sites given fiber constraints?
- What minimum interconnect throughput is required to link initial sites to hyperscaler hero regions?
- How will rapid accelerator cycles (e.g., H100 to GB200) affect depreciation and tenant demand over 5 years?
