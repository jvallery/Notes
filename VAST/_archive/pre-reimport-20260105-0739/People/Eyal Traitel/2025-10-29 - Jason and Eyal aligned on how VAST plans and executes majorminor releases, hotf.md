...
created: { { DATE } }
status: "done"
counterpart: "[[Eyal Tritel]]"
role: ""
team: ""
company: ""
series: "1-1/Eyal Tritel"
cadence: "Weekly"
meeting_mode: "Video"
location_or_link: ""
calendar_url: ""
...
privacy: "internal"
ai_extracted: true
transcript_path: "00 Inbox/Transcripts/20251029 0934 Parallels Transcription.txt"
tags: [meeting, "1-1"]
---

# 1:1 — Eyal Tritel — 2025-10-29
...
Jason and Eyal aligned on how VAST plans and executes major/minor releases, hotfixes, and service packs, and discussed the path toward SaaS/multi-tenant readiness. Eyal outlined intake channels, planning roles, and current constraints; Jason shared cloud goals and the need to prioritize core multi-tenancy and cluster capabilities. Eyal will send the multi-tenancy gap list; they will schedule follow-ups and meet during Jason’s TLV visit.

## Key facts learned

- Eyal joined VAST in Dec 2024; Noa is a veteran focusing on major releases; Eyal focuses on minor releases.
- Feature intake: leadership/architects (e.g., NVIDIA asks), SE requests via Salesforce tied to opportunities, triaged by Tomer Haggai’s team with Jonathan Hayes; bi-weekly reviews.
- Release managers run day-to-day for majors and minors; ops (Shelly Martin) and R&D (Liraz) drive phase-gate documentation and process.
- vForce (Roy Sterman) and Dafna’s team manage service packs and hotfixes, including back/forward-porting fixes.
- Minor releases are treated like full releases with regression and performance testing; weekly content/testing reviews.
- Planning is highly dynamic with frequent urgent requests (e.g., Tesla), causing scope churn and parallel streams.
- 5.6 phase gates underway; target GA July next year.
- Recent cadence ~2–3 major releases per year.
- Multi-tenancy gap list exists; major blocker: auth providers limited to 8 and configured at host cluster, not tenant-scoped—large effort to scale and tenantize.
- Control plane (Polaris/Iceland) is more cloud-native; cluster layer not yet operating in agile/SaaS mode.
- Jason’s goals: enable SaaS/multi-tenant, improve cloud cost/perf, add core capabilities (e.g., Data Spaces multi-tenant, offload to object).
- Jason will be in Tel Aviv 2025-11-23 to 2025-11-26.

## Outcomes

- Eyal to send Confluence page with multi-tenancy gaps.
- Plan to schedule a follow-up call.
- Plan to meet in person during Jason’s TLV visit (Nov 23–26).

## Decisions

- (none)

## Action items (for Eyal Tritel)

- [x] Send Confluence page detailing multi-tenancy gaps to Jason @Eyal Tritel ⏫ ✅ 2025-11-08
- [x] Schedule a follow-up call to dive deeper into release planning and VAST on Cloud needs @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Schedule in-person meeting during Tel Aviv visit (2025-11-23 to 2025-11-26) @Jason Vallery 🔼 ✅ 2025-11-08

## Follow-ups

- [x] Review multi-tenancy gap list and identify highest-priority items for SaaS and on-prem multi-tenancy @Jason Vallery ⏫ ✅ 2025-11-08
- [x] Align with Polaris/Iceland teams on which gaps can be addressed in control plane vs. cluster @Jason Vallery 🔼 ✅ 2025-11-08
- [x] Confirm 5.6 phase-gate timeline and implications for delivering key multi-tenancy items @Jason Vallery 🔼 ✅ 2025-11-08

## Risks

- Constant urgent field requests disrupt planned scope and resource allocation.
- Parallel major/minor/hotfix streams strain the release machinery and QA capacity.
- Hotfix back/forward-port complexity can block customer upgrades if not aligned.
- Auth provider limit (8) and non-tenant-scoped config impede multi-tenant/SaaS scale.
- Cluster-side agility for SaaS not yet defined; reliability requirements constrain rapid change.
- Overbooked teams may delay critical multi-tenancy gaps beyond 5.6.

## Open questions

- What is the finalized, prioritized list of multi-tenancy gaps and target releases?
- How can VAST accelerate delivery of high-impact gaps (e.g., auth providers >8, tenant-scoped providers) ahead of 5.6?
- What process changes are needed to enable SaaS agility on the cluster layer without compromising reliability?
